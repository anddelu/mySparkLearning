...
case class fpResult(comA: List[String], comAB: List[String], comB: List[String], confA2B: Float, supportB: Double, liftB: Double)
...
yield fpResult(i._1, j._1, gList, j._2 / i._2, gListSupport, j._2 / (i._2 * gListSupport) )  

ruleCollect.map(a => (a.comA, a.comB, a.comAB, a.confA2B, a.liftB)).foreach(println)
